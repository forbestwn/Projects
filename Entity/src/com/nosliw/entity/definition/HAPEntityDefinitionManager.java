...
public class HAPEntityDefinitionManager implements HAPStringable{
	...
	public HAPEntityDefinitionManager(HAPConfigure configuration, HAPDataTypeManager dataTypeMan, HAPOptionsDefinitionManager optionsMan){
